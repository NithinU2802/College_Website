<div class="ft">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-5 col-sm-6">
                ...
                <ul class="ps" >
                    ...
                    <li><a href="<?php echo e($footer->link); ?>" target="_blank"><i class="fa-solid fa-angle-right" id="lc"></i> <?php echo e($footer->name); ?> </a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <ul id="ps" class="ps">
                    <?php $__currentLoopData = $footer3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e($footer->link); ?>" target="_blank"><i class="fa-solid fa-angle-right" id="lc"></i> <?php echo e($footer->name); ?> </a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul><br><br>
            </div>
    ...
    <div class="text-center text-white">
        <p>&copy;  Copyright <?php echo e(date('Y')); ?> KRCT | All Rights Reserved. Developed and Maintained by CSE Batch (2020-2024)</p>
    </div><br>
</div>

</body>
</html>
<?php /**PATH C:\Users\Nithin U\Dropbox\My PC (LAPTOP-GE7L8071)\Desktop\clgweb\resources\views/frontend/footer.blade.php ENDPATH**/ ?>