        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel" data-interval="true">
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php echo e($key==0 ? 'active':''); ?>">
                    <img src="<?php echo e(asset("$sliderItem->image")); ?>" alt="..." class="d-block w-100">
                    ...
                    <div class="col">
                        ...
                        <div class="row my-auto">
                            <div id="carouselfornews" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000" data-bs-pause="hover">
                                <div class="carousel-inner">
                                    <?php $__currentLoopData = $news->split(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $newsItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php echo e($key==0 ? 'active':''); ?>" >
                                        <div class="row mx-auto py-2">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 pt-3 py-4 d-flex">
                                                <div class="card mx-auto" id="new">
                                                    <img class="card-img-top" src="<?php echo e(asset("$newsItem->image")); ?>" alt="Card image cap">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12"  >
                        <div class="container-fluid">
                            ...
                            <marquee id="marq" direction = "up" OnMouseOver="this.stop();" OnMouseOut="this.start();">
                                <div class="row">
                                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row py-4">
                                        <div class="col-lg-2 col-md-2 col-sm-2 d-flex ">
                                            <button type="button" class="btn btn-primary btn-lg btnsize">
                                                <p style="margin:0;"><?php echo e($card->month); ?></p>
                                                <span class="badge "><?php echo e($card->date); ?></span>
                                            </button>
                                        </div>
                                         <div class="col-lg col-sm-10 d-flex">
                                            <div class="card">
                                                <h5 class="card-title"><?php echo e($card->title); ?></h5>
                                                <p class="card-text">Time:<?php echo $card->time; ?> <br><a href="<?php echo e(asset("$card->link")); ?>">Link</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="card why-c">
          <img  src="<?php echo e(asset("$card->image")); ?>" class="card-img-top"  alt="...">
          <div class="card-body">
            <h5 class="card-title why-ct"><b><?php echo e($card->title); ?></b></h5>
					...
					<div class="col-lg-12">
						<div class="placement-slider owl-carousel">
                            <?php $__currentLoopData = $placements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="card p-c">
                                    <img src="<?php echo e(asset("$placement->image")); ?>" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h5 class="card-title"><?php echo e($placement->name); ?></h5>
                                        <p class="card-text"><?php echo e($placement->department); ?></p>
                                        <p style="height:2rem; font-weight:bold;"><?php echo e($placement->company); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div><br>
        ...
        <div class="container my-3 py-5 text-center">
            ...
            <div class="row my-auto">
                <div id="carouselforwhat" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <?php $__currentLoopData = $feedback->split(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $FeedbackItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="carousel-item <?php echo e($key==0 ? 'active':''); ?>">
                            <div class="row d-flex justify-content-center">
                                <?php $__currentLoopData = $FeedbackItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $FeedbackItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column">
                                            <img style="height:130px; width:130px"  src="<?php echo e(asset("$FeedbackItem->image")); ?>" alt="img" class="img-fluid rounded-circle w-50 mb-4 mx-auto">
                                            <p><?php echo e($FeedbackItem->description); ?></p>
                                            <aside class="align-self-center flex-grow d-flex align-items-end"><h3><?php echo e($FeedbackItem->name); ?></h3></aside>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="container">
	...
	<div class="brand-carousel section-padding owl-carousel">
        <?php $__currentLoopData = $recruiters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recruiter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item"><img alt="" src="<?php echo e(asset("$recruiter->image")); ?>"></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	</div>
</div><br>
            ...
            <div class="col-12 m-auto">
                <div class="gallery-carousel owl-carousel owl-theme">
                    ...
                    <div class="item mb-4 border-0 shadow ih">
                        <a href="<?php echo e(asset("$gallery->image")); ?>" class="fancybox" data-fancybox="gallery1">
                            <img src="<?php echo e(asset("$gallery->image")); ?>" alt="" style="height: 280px;" >
                        </a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\wwwse\Downloads\clgweb\clgweb\resources\views/frontend/index.blade.php ENDPATH**/ ?>